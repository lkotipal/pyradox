...
def compute_unit_stat_function(stat_key):
    def compute_unit_stat(terrain_key, terrain):
        ...
        return pyradox.table.wiki_colored_percent_string(terrain["units"][stat_key] or 0.0)
...
columns = (
    ...
    ("Attrition", lambda k, v: pyradox.table.wiki_colored_percent_string(v["attrition"] or 0.0, color = "red")),
    ...
    ("Enemy air superiority", lambda k, v: pyradox.table.wiki_colored_percent_string(v["enemy_army_bonus_air_superiority_factor"] or 0.0)),
    )
